...
$bsql = "with t1 as (SELECT extract(month from date_sales) as month,  extract(year from date_sales) as year, price, qty, product_ID as ID FROM sale 
                where date_sales between to_date('".$_GET['p1']."', 'yyyy-mm') and to_date('".$_GET['p2']."', 'yyyy-mm'))
select categories.name, t1.month, t1.year, sum(t1.price) as saleprice, sum(qty) as salevolume from 
        t1 join products on t1.ID = products.ID 
    ...
    <div id="page-wrapper">
        ...
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h2>Product-type distribution query</h2>
                        <p> Shows the trend of the monthly market share by product type in a certain period of time. The sales value and sales volume are displayed separately, and different product types are indicated by different colors.
<p>User options: time range, product type
<p>Application scenario: The query is designed to help companies determine product sales. The small curve fluctuation means the continuous demand of a product, and the large curve fluctuation may represent the birth of a phenomenon-level "hot product" or the apoptosis of a product.</p>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h4>Selection</h4>
                        <form action="1st_query.php"  class="form-inline">
                            ...
                            <div class="form-group">
                                ...
                                <select name="p3" class="selectbox">
                                    ...
                                    <option value="make up before the milk">make up before the milk</option>
                                    <option value="Foundation">Foundation</option>
											<option value="Concealer">Concealer</option>
											<option value="Powder">Powder</option>
											<option value="Blush">Blush</option>
										...
										<select name="p5" class="selectbox">
                                    <option> optional </option>
                                    <option value="make up before the milk">make up before the milk</option>
                                    <option value="Foundation">Foundation</option>
											<option value="Concealer">Concealer</option>
